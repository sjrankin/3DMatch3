...
public class Versioning: CustomStringConvertible
{
    ...
    public static let ApplicationName = "3D Match 3"
    
    /// Tag for the application.
    public static let Tag: String = "Alpha"
    
    /// ID of the application.
    public static let ProgramID = "C6289C3F-3FA3-4D48-BB84-0F1C25000A06"
    ...
    public static let Build: Int = 50
    ...
    /// Copyright years.
    public static let CopyrightYears = [2022]
